...
int main()
{
    ...
    if(option=='1')
    {
     cout<<  "Please enter 2 numbers to add:\n";
       cin>>num1>>num2;
       cout<<"Your total is: "<<add(num1, num2)<<endl;
    ...
    if(option == '2')
    {
       ...
       cin>>num1>>num2;
       cout<<"Your total is: "<<subtract(num1, num2)<<endl;
    }
    ...
    if(option == '3')
    {
       ...
       cin>>num1>>num2;
       cout<<"Your total is: "<<multiply(num1, num2)<<endl;
    }
    ...
    if(option == '4')
    {
       ...
       cin>>num1>>num2;
       cout<<"Your total is: "<<divide(num1, num2)<<endl;
    }
